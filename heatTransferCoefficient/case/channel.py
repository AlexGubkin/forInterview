...
# NETGEN_1D_2D_1 = pipeWithDuctMesh.Triangle(algo=smeshBuilder.NETGEN_1D2D,geom=inlet)
...
# #Viscous_Layers_2D_1 = NETGEN_1D_2D_1.ViscousLayers2D(0.5, 10, 1.2, inletEdgesIDs, 0)
# Viscous_Layers_2D_1 = NETGEN_1D_2D_1.ViscousLayers2D(0.2, 2, 1.1, [], 1)

Quadrangle_2D = pipeWithDuctMesh.Quadrangle(algo=smeshBuilder.QUADRANGLE, geom=inlet)
