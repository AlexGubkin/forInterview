...
#Viscous_Layers_2D_1 = NETGEN_1D_2D.ViscousLayers2D(0.5, 10, 1.2, inletEdgesIDs, 0)
Viscous_Layers_2D_1 = NETGEN_1D_2D.ViscousLayers2D(0.2, 10, 1.1, [], 1)
...
NETGEN_2D_Parameters_1.SetWorstElemMeasure( 32767 )
NETGEN_2D_Parameters_1.SetCheckChartBoundary( 0 )
#Viscous_Layers_2D_2 = NETGEN_1D_2D_1.ViscousLayers2D(0.2, 5, 1.2, inletEdgesIDs, 0)
Viscous_Layers_2D_2 = NETGEN_1D_2D_1.ViscousLayers2D(0.1, 5, 1.1, [], 1)
